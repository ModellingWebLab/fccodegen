...
void compute(double time)
{
   // time: time (millisecond)
    ...
    if (fabs(47.130000000000003 + Y[0]) < 1.0000000000287557e-6)
    ...
    if (fabs(Y[0]) < 2.6712338705498262e-6)
    ...
    if (fabs(Y[0]) < 1.3356169352749131e-6)
    ...
    if (fabs(-15.0 + Y[0]) < 1.3356169352718439e-6)
